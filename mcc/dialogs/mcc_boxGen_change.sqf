...
if (_type == 1) then //Add weapon + mags
	...
	if (MCC_gearDialogClassIndex == 2) then	{tempBox addItemCargo [_class,1]};
	if (MCC_gearDialogClassIndex == 8) then	{tempBox addBackpackCargo [_class,1]};
	if ((MCC_gearDialogClassIndex != 2)&&(MCC_gearDialogClassIndex != 9)&&(MCC_gearDialogClassIndex != 8))  then
		{
...
if (_type == 2) then //Add weapon/mag without mags
	{
		...
		if (MCC_gearDialogClassIndex == 2) then	{tempBox addItemCargo [_class,1]};
		if (MCC_gearDialogClassIndex == 8) then	{tempBox addBackpackCargo [_class,1]};
		if ((MCC_gearDialogClassIndex != 2)&&(MCC_gearDialogClassIndex != 9)&&(MCC_gearDialogClassIndex != 8))  then	{tempBox addWeaponCargo [_class,1]};
	};
