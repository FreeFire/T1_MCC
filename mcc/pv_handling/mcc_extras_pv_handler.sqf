...
//==============================================================================================================================================================================
	...
	["POPZ", {[(_this select 0), (_this select 1), (_this select 2), (_this select 3), (_this select 4), (_this select 5)] execVM MCC_path + "mcc\general_scripts\popz\popz_exec.sqf";}] call CBA_fnc_addEventHandler;
	*/
};