	...
	switch (_type) do
	{
		...
		case 4:	//Set Canceled
	   {
		...
		case 5:	//End Mission : Sucess
		{
			...
			{
			MCC_capture_var = MCC_capture_var + FORMAT ['
								[[2,{titlecut ["Mission Accomplished","BLACK OUT", 3];sleep 3;endMission "LOSER"}], "MCC_fnc_globalExecute", true, false] spawn BIS_fnc_MP;
								'
								];
			} else
			{
			[[2,{titlecut ["Mission Accomplished","BLACK OUT", 3];sleep 3;endMission "WINNER"}], "MCC_fnc_globalExecute", true, false] spawn BIS_fnc_MP;
			};
		};
		...
		case 6:	//End Mission : Fail
		{
			...
			{
			MCC_capture_var = MCC_capture_var + FORMAT ['
								[[2,{titlecut ["Mission Failed","BLACK OUT", 3];sleep 3;endMission "LOSER"}], "MCC_fnc_globalExecute", true, false] spawn BIS_fnc_MP;
								'
								];
			} else
			{
